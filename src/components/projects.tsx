...
export const Projects = ({ className }: ProjectsProps) => {
    return (
        <div className="flex flex-col m-auto w-[90%] md:w-[80%] xl:w-[70%] transition-all hover:bg-opacity-80">
            <Outlet />
            <div className="bg-secondary ml-12 mr-12 mt-3 bg-opacity-[60%] hover:bg-opacity-80 transition-all rounded-2xl flex flex-row pl-2 pr-2 md:pl-6 md:pr-6 justify-between text-lg p-3">
