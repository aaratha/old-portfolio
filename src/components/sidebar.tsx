        ...
        <div className='flex shad flex-col text-white bg-black md:left-0 h-[12vh] md:h-screen md:w-[15%] m-autop'>
            <div className='flex flex-row md:flex-col justify-center border border-white md:h-screen'>
                <div className='flex flex-col w-full md:w-auto justify-between md:justify-center border border-white md:h-full m-2'>
                    <h1 className='flex text-white text-lg lg:text-2xl md:m-5 text-center justify-center'>Aseem Ratha</h1>
                    <nav className='flex justify-between md:flex-col m-auto md:mt-[36vh] w-full md:w-auto text-lg'>
                        <Link className='flex justify-left ml-5 md:m-0 w-20' onMouseEnter={toggleDrawHome} onMouseLeave={toggleDrawHome} to="/">
                        ...
                        <Link className='flex w-20 justify-left' onMouseEnter={toggleDrawProjects} onMouseLeave={toggleDrawProjects} to="/projects">
                        ...
                        <Link className='flex w-20 justify-left mr-5 md:m-0' onMouseEnter={toggleDrawContact} onMouseLeave={toggleDrawContact} to="/contact">
